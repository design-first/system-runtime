...
describe('a System Runtime component', function () {
  ...
  it('can add an event', function (done) {
    ...
    yoda.on('moving', () => this.address('Dagobah'))
    yoda.moving()
  ...
  it('can add an event on a new context', function (done) {
    ...
    yoda.on('moving', () => this.lastName('Skywalker'), luke)
    yoda.moving()
  ...
  it('can remove all event', function (done) {
    ...
    yoda2.on('moving', () => this.address('Dagobah'))
    yoda2.off()
  ...
  it('can remove an event with its id', function (done) {
    ...
    const behaviorId = yoda3.on('moving', () => this.address('Dagobah'))
  ...
  it('can add an event on a property change', function (done) {
    ...
    yoda.on('lastName', (val) => this.address('Dagobah'))
  ...
  it('can use dynamic import', function (done) {
    const Person = runtime.require('Person')
    const yoda = new Person({
      firstName: 'Yoda',
      lastName: 'Master',
    ...
    yoda.on('lastName', async function (val) {
      const newValue = await import('../test/module/test.js')
  ...
  it('can add an event on a structure change', function (done) {
    ...
    yoda.on('custom.property0', (val) => this.custom().property3('changed'))
  ...
  it('can add an event on a specific property of an element of a collection', function (done) {
    ...
    yoda.on('location.cities[0].street', (val) =>
  ...
  it('can add an event on a specific property of all elements of a collection', function (done) {
    ...
    yoda.on('location.cities.street', (val) =>
  ...
  it('can call a parent method', function () {
    ...
    Person.on('fullName', () => this.firstName() + ' ' + this.lastName())

    Teacher.on(
      'fullName',
      () => 'Great Teacher ' + this.require('Person').fullName(this)
    )
  ...
  it('can send an error catched by the runtime', function (done) {
    ...
    runtime.on('error', (data) => this.require('yoda').lastName('error'))

    yoda.on('testMethod', () => ANonDefinedFunction())
    yoda.testMethod()
  ...
  it('can send an error catched by a component', function (done) {
    ...
    yoda.on('error', (data) => this.lastName('error'))
  ...
  it('can send an error catched by the system', function (done) {
    ...
    runtime
      .system()
      .on('error', (data) => this.require('yoda1').lastName('error'))
